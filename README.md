...
```
src/
  components/   # 16 компонентов = 16 секций страницы
...
Собранный `dist/index.html` оборачивается в PHP-пролог Bitrix, JS/CSS-чанки и картинки загружаются в `/local/presentations/power_system_zapolyarye/`.
