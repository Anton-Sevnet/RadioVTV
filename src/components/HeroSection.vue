    ...
    <div class="relative z-20 max-w-7xl mx-auto px-4 py-10 -mt-16">
      <div class="bg-night/80 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-10">
        ...
        <p class="text-gray-400 text-sm leading-relaxed max-w-3xl">
          Идея для тех, кому хочется собрать свой аварийный радиомаяк: дешёвые материалы,
          автономное питание и эфир там, где нет розетки, вышек и привычной связи.
          Небольшая «станция судного дня» для лагеря, базы или точки в глуши.
        </p>
