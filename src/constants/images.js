...
export const GALLERY_PHOTOS = [
  ...
  { src: 'konstantin-voronov-kolskii-poluostrov-khibiny-gory-priroda-p.jpg', alt: 'Природа Заполярья' },
  { src: 'konstantin-voronov-priroda-peizazh-kolskii-poluostrov-gory-k.jpg', alt: 'Пейзаж гор и водоёма' },
  { src: 'pavel-vashchenkov-kolskii-poluostrov-priroda-peizazh-gory-kh.jpg', alt: 'Горы Кольского полуострова' },
  { src: 'vladimir-riabkov-khibiny-kolskii-poluostrov-murmanskaia-obla.jpg', alt: 'Хибины, Мурманская область' },
  { src: 'vladimir-riabkov-priroda-peizazh-kolskii-poluostrov-khibiny.jpg',  alt: 'Природа Хибин' },
]
